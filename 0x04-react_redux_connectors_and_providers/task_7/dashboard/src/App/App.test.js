...
describe('App Renders', () => {
  ...
  it('an alert and calls the function logout when ctrl-h is pressed', () => {
    ...
    // unfortunately we're not mocking the store fed in our App because it comes in through context
    // no way to do store.getActions() to see what was dispatched
  });
  ...
  it('NOT the CourseList component', () => {
